...
5. 评论可以被删除。
6. 类似 Markdown 的行内代码块显示功能，用户输入的用 &ast;&ast; 包含起来的内容都会被处理成用 `<code>` 元素包含。例如输入 &ast;console.log&ast; 就会处理成 `<code>console.log</code>` 再显示到页面上。 

<a href="/assets/img/posts/E01D3698-F041-4149-9626-849F023E5638.png" target="_blank">![示例图片](/assets/img/posts/E01D3698-F041-4149-9626-849F023E5638.png)</a>
...
<a href="/assets/img/posts/04093DE1-B4C0-4CBD-B3F8-DF924C9F6799.png" target="_blank">![示例图片](/assets/img/posts/04093DE1-B4C0-4CBD-B3F8-DF924C9F6799.png)</a>
